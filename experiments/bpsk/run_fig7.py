"""
run_fig7.py -- Tái lập Hình 7: Analytical vs Simulated (mô phỏng chuỗi bit) (Section IX.E)
Chạy: python3 experiments/bpsk/run_fig7.py
"""
import sys, os
...
def main():
    ...
    ax.set_title('Hình 7 — Analytical vs Simulated (3×10^5 bit/điểm)')
