""" 
run_fig6.py -- Reconstruct Figure 6: Pe, Pguess ideal vs real (Section IX.D, eq.41-43)
"""
import sys, os
...
def main():
    alpha, beta, sigma = 4.2, 1.4, 0.1  # strong turbulence, see pages 10-11
    ...
    ax.set_xlabel('γ (Field Amplitude)')
    ax.set_ylabel('Probability')
    ax.set_title('Figure 6 — Relay detection & Eavesdropper confidence')
