""" 
run_fig4.py -- Reconstruct Figure 4: Direct vs Relay, weak turbulence (Section IX.B)
"""
import sys, os
...
def main():
    ...
    ax.set_title('Figure 4 — Direct vs Relay, weak turbulence, σ=0.1\n(using eq.39 — note: ~3-8x lower than true value, see bug #4)')
